...
number: 2
date: 2026-09-08
title: Present tense, prefixes, and gender by suffix
...
| English | German | haben | sein | kaufen | Regular ending |
|---|---|---|---|---|---|
| I | ich | habe | bin | kaufe | **-e** |
| you | du | hast | bist | kaufst | **-st** |
| he / she / it | er / sie / es | hat | ist | kauft | **-t** |
| we | wir | haben | sind | kaufen | **-en** |
| you all | ihr | habt | seid | kauft | **-t** |
| they / formal you | sie / Sie | haben | sind | kaufen | **-en** |

About 80 % of German verbs follow this weak pattern: strip `-en` from the infinitive and add the ending. `haben` and `sein` do not; they have to be memorised.

`Sie` (capital S) is formal "you" and takes the same form as third-person plural.

Verbs in `-eln` drop the *e* in the ich-form: ich entwick**le**, ich verhand**le**.

## Separable prefixes (10)
...
**Possessivpronomen im Nominativ** — kept here verbatim until the *declension* topic opens up.
...
| sie / Sie (they / formal you) | ihr / Ihr | ihre / Ihre | ihr / Ihr | ihre / Ihre |
